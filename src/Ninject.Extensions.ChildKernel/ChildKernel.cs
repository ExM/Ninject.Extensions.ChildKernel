...
namespace Ninject.Extensions.ChildKernel
{
    ...
    public class ChildKernel : KernelBase, IChildKernel
    {
        ...
        public ChildKernel(IResolutionRoot parent, params INinjectModule[] modules)
            : base(CreateComponentContainerOfStandartKernel(null), new NinjectSettings(), modules)
        {
        ...
        /// </summary>
        /// <param name="settings">The settings.</param>
        private static IComponentContainer CreateComponentContainerOfStandartKernel(INinjectSettings settings)
        {
            var container = new ChildKernelComponentContainer(null);
